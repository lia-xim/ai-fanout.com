...
- Umami data for this site is limited to six months under the owner-run, exact-website reset procedure in `docs/analytics-retention.md`; the public runtime has no analytics-admin credential.
